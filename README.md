...
**Pre-alpha / initial implementation.** The repository now contains an early functional Flutter interface, a FastAPI foundation, automated tests, and GitHub CI. It is not ready for installation, real data, or production use.
...
Data is currently in memory and is reset when the app restarts. Authentication, SQLite persistence, PostgreSQL, synchronization, notifications, and production security are still future work.
...
Flutter and Python must already be installed on the development environment.
